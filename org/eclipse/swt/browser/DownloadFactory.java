...
class DownloadFactory
{
  ...
  void createCOMInterfaces()
  {
    this.supports = new XPCOMObject(new int[] { 2 })
    {
      ...
      {
        return DownloadFactory.this.QueryInterface(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1]);
      }
    ...
    this.factory = new XPCOMObject(new int[] { 2, 0, 0, 3, 1 })
    {
      ...
      {
        return DownloadFactory.this.CreateInstance(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1], paramAnonymousArrayOfInt[2]);
      }

      public int method4(int[] paramAnonymousArrayOfInt)
      {
        return DownloadFactory.this.LockFactory(paramAnonymousArrayOfInt[0]);
      }
    };
  }
  ...
  int CreateInstance(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localDownload.AddRef();
    XPCOM.memmove(paramInt3, new int[] { localDownload.getAddress() }, C.PTR_SIZEOF);
    return 0;
  }
 ...
 * Qualified Name:     org.eclipse.swt.browser.DownloadFactory
