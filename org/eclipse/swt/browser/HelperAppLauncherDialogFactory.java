...
class HelperAppLauncherDialogFactory
{
  ...
  void createCOMInterfaces()
  {
    this.supports = new XPCOMObject(new int[] { 2 })
    {
      ...
      {
        return HelperAppLauncherDialogFactory.this.QueryInterface(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1]);
      }
    ...
    this.factory = new XPCOMObject(new int[] { 2, 0, 0, 3, 1 })
    {
      ...
      {
        return HelperAppLauncherDialogFactory.this.CreateInstance(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1], paramAnonymousArrayOfInt[2]);
      }

      public int method4(int[] paramAnonymousArrayOfInt)
      {
        return HelperAppLauncherDialogFactory.this.LockFactory(paramAnonymousArrayOfInt[0]);
      }
    };
  }
  ...
  int CreateInstance(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject = new HelperAppLauncherDialog();
      ((HelperAppLauncherDialog)localObject).AddRef();
      XPCOM.memmove(paramInt3, new int[] { ((HelperAppLauncherDialog)localObject).getAddress() }, C.PTR_SIZEOF);
    }
    else
    {
      localObject = new HelperAppLauncherDialog_1_9();
      ((HelperAppLauncherDialog_1_9)localObject).AddRef();
      XPCOM.memmove(paramInt3, new int[] { ((HelperAppLauncherDialog_1_9)localObject).getAddress() }, C.PTR_SIZEOF);
    }
    return 0;
  }
 ...
 * Qualified Name:     org.eclipse.swt.browser.HelperAppLauncherDialogFactory
