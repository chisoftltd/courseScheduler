...
class ExternalFactory
{
  ...
  void createCOMInterfaces()
  {
    this.supports = new XPCOMObject(new int[] { 2 })
    {
      ...
      {
        return ExternalFactory.this.QueryInterface(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1]);
      }
    ...
    this.factory = new XPCOMObject(new int[] { 2, 0, 0, 3, 1 })
    {
      ...
      {
        return ExternalFactory.this.CreateInstance(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1], paramAnonymousArrayOfInt[2]);
      }

      public int method4(int[] paramAnonymousArrayOfInt)
      {
        return ExternalFactory.this.LockFactory(paramAnonymousArrayOfInt[0]);
      }
    };
  }
  ...
  {
    External localExternal = new External();
    localExternal.AddRef();
    XPCOM.memmove(paramInt3, new int[] { localExternal.getAddress() }, C.PTR_SIZEOF);
    return 0;
  }
