...
class PromptService2Factory
{
  ...
  void createCOMInterfaces()
  {
    this.supports = new XPCOMObject(new int[] { 2 })
    {
      ...
      {
        return PromptService2Factory.this.QueryInterface(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1]);
      }
    ...
    this.factory = new XPCOMObject(new int[] { 2, 0, 0, 3, 1 })
    {
      ...
      {
        return PromptService2Factory.this.CreateInstance(paramAnonymousArrayOfInt[0], paramAnonymousArrayOfInt[1], paramAnonymousArrayOfInt[2]);
      }

      public int method4(int[] paramAnonymousArrayOfInt)
      {
        return PromptService2Factory.this.LockFactory(paramAnonymousArrayOfInt[0]);
      }
    };
  }
  ...
  {
    PromptService2 localPromptService2 = new PromptService2();
    localPromptService2.AddRef();
    XPCOM.memmove(paramInt3, new int[] { localPromptService2.getAddress() }, C.PTR_SIZEOF);
    return 0;
  }
 ...
 * Qualified Name:     org.eclipse.swt.browser.PromptService2Factory
