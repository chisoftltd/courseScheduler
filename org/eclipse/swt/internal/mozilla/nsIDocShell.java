...
public class nsIDocShell extends nsISupports
{
  ...
  public static final nsID NS_IDOCSHELL_IID = new nsID("69e5de00-7b8b-11d3-af61-00a024ffc08c");
  ...
  public int InternalLoad(int paramInt1, int paramInt2, int paramInt3, int paramInt4, char[] paramArrayOfChar, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 3, getAddress(), paramInt1, paramInt2, paramInt3, paramInt4, paramArrayOfChar, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramArrayOfInt1, paramArrayOfInt2);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 26, getAddress(), paramArrayOfInt);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 28, getAddress(), paramInt1, paramInt2, paramArrayOfInt);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 32, getAddress(), paramInt);
  }

  public int GetZoom(float[] paramArrayOfFloat)
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 33, getAddress(), paramArrayOfFloat);
  }

  public int SetZoom(float paramFloat)
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 34, getAddress(), paramFloat);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 42, getAddress(), paramInt);
  }

  public int TabToTreeOwner(int paramInt, int[] paramArrayOfInt)
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 43, getAddress(), paramInt, paramArrayOfInt);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 46, getAddress(), paramInt);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 48, getAddress(), paramArrayOfInt);
  }
  ...
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 50, getAddress(), paramInt);
  }

  public int GetShouldSaveLayoutState(int[] paramArrayOfInt)
  {
    return XPCOM.VtblCall(nsISupports.LAST_METHOD_ID + 51, getAddress(), paramArrayOfInt);
  }
}

/* Location:           /Users/jeff.kusi/Downloads/AutomatedScheduler - Fakhry & Kusi.jar
 * Qualified Name:     org.eclipse.swt.internal.mozilla.nsIDocShell
